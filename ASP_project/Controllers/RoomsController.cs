...
namespace ASP_project.Controllers
{
    public class RoomsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Room_ID,Room_Number,Room_Size,Rent_Per_Day,Room_Status,Rent_Type,Room_Note")] Room room)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Room_ID,Room_Number,Room_Size,Rent_Per_Day,Room_Status,Rent_Type,Room_Note")] Room room)
        {
            if (id != room.Room_ID)
            {
                return NotFound();

...
namespace ASP_project.Controllers
{
    public class PaymentsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Payment_Id,Payment_Amount,Payment_Currency,Payment_Date,Payment_Method,Payment_Status,Payment_Note")] Payment payment)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Payment_Id,Payment_Amount,Payment_Currency,Payment_Date,Payment_Method,Payment_Status,Payment_Note")] Payment payment)
        {
